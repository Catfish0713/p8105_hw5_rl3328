...
For true mu=0, the sample average of μ^ across tests for which the null(μ=0) is rejected  is produced by false positive data(meaningless);
For true μ=1:6, as the effect size increases, the power increases, the tests for which the null(μ=0) is rejected increases, the sample average of μ^ becomes more close  to the true value of μ. (I stated the reasons within this sentence)